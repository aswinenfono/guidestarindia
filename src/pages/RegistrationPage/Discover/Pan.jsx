...
const RegistrationSecond = () => {
    ...
    //     const findQuestion = discoverInitalData?.documents.find(Qn => Qn.question_no === number)

    //     if (!findQuestion) return null

    //     if (findQuestion.question_no === 'DRQ-00001') {
    //         return (
    //             <>
    ...
    //         )
    //     }
    //     else if (findQuestion.question_no === 'DRQ-00002') {
    //         return (
    //             <>
    //                 <CustomSelection label="Has you IT PAN changed ?" />
    //                 <ParagraphComp Data={{ text: 'Income Tax Permanent Account Number(IT PAN) of the Non Profit', className: 'mt-[8px] text-black text-sm px-[8px]' }} />
    //             </>
    //         )
    //     }
    //     else if (findQuestion.question_no === 'DRQ-00003') {
    //         return (
    //             <>
            ...
            {/* 
                <div>
                    <div className='p-[20px] border-2 rounded-t-xl flex items-center justify-between'>
                        ...
                        <ButtonComp text='Add Row' type={'button'} className='px-[20px] text-white bg-[#004878] rounded-full py-[5px]' onClick={openModal} />
                    </div>
