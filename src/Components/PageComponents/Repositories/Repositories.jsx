    ...
    return (
        <>
            ...
            <div className='p-[10px] max-sm:py-[70px] flex bg-[#f7f7f7] flex-col'>
                <HeaderCompo tagType="h1" text='Get involved with NPOs to make a difference' className='RepositoriesHeader max-sm:text-3xl max-md:text-4xl text-center text-black' />
