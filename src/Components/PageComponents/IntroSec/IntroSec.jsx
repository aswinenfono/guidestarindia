                            ...
                            <Row className=' row-cols-1 row-cols-lg-2 gap-y-2'>
                                <Col lg={7} class="">
                                    <div className='IntroSecInputContainer'>
                                        <input type="text" placeholder="Enter organization name or keyword " className="IntroSecInput max-sm:text-xl max-sm:h-[40px]" />
                                ...
                                <Col lg={5} className='flex gap-2 max-md:justify-start justify-end'>
                                    <ButtonComp className="IntroSecSearchButton max-sm:text-xl max-sm:h-[40px] rounded-md" text='Search' />
                                    <ButtonComp className="IntroSecSearchButton2 max-sm:text-xl max-sm:h-[40px] rounded-md" text='Register for free' />
                                </Col>
                            </Row>
