        ...
        <>
            <m.div className='SealsSec px-[10%] py-5 text-center ' {...fadeIn}>
                <div>
                    ...
                    <ParagraphComp Data={{ text: 'Based on GuideStar India’s 7 pillar assessment rubric covering Situation Analysis, Theory of Change, Programme Intervention & Resilience, Infrastructure, Finance & Compliance, Governance & Accountability, Evidence of Impact, Learning & Reflection' }} />
                </div>
