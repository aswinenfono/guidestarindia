        ...
        <>
            <m.div className='SealsSec max-sm:py-[70px] px-[10%] py-5 text-center ' {...fadeIn}>
                <div>
                    ...
                    <ParagraphComp className='max-sm:text-lg' text='Based on GuideStar India’s 7 pillar assessment rubric covering Situation Analysis, Theory of Change, Programme Intervention & Resilience, Infrastructure, Finance & Compliance, Governance & Accountability, Evidence of Impact, Learning & Reflection' />
                </div>
                ...
                <Row className='row-cols-1 gap-y-5 row-cols-lg-4 row-cols-sm-2'>
                    {
                        Data?.MapItems?.map(ele =>
                            <Col className='SealsSecCard'>
                                <ImageComp source={ele?.image} className="SealsSecCardImg max-sm:h-[100px]" />
