const infoData = [
    ...
    {
        img: "/Images/presentation1.png",
        imgHov: "/Images/presentationhov.png",
        title: "Support Capacity Building and Due Diligence for NPOs",
        content: "Educate and equip NPOs to build trust and transparency through a comprehensive framework.",
        btnName: "Learn more",
