...
const Philanthropy = () => {
    return (
        <>
            <section className="py-[100px] lg:py-[90px] md:py-[75px] sm:py-[50px]">
                <Container>
                    ...
                    <InfoBannerStyle01 animation={fadeIn} grid="row row-cols-1 row-cols-lg-4 gap-y-5" className="justify-center" data={infoData} />
                </Container>
            </section>
        </>
    )
